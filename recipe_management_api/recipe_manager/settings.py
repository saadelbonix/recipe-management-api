...
CORS_ALLOWED_ORIGINS = [o.strip() for o in os.getenv("DJANGO_CORS_ORIGINS", "").split(",") if o]
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "Manage cooking recipes with JWT authentication and filtering.",
    "VERSION": "1.0.0",
}
